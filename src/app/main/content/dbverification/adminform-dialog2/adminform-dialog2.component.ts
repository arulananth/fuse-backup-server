...
@Component({
  selector: 'adminform-dialogf12',
  templateUrl: './adminform-dialog2.component.html',
  styleUrls: ['./adminform-dialog2.component.scss']
})
export class AdminformDialogf12Component implements OnInit {
  addedForm: FormGroup;
submitted = false;
  constructor(private formBuilder: FormBuilder,public dialogRef: MatDialogRef< AdminformDialogf12Component>,
