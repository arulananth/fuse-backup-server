...
import { MatIconModule, MatRippleModule,MatExpansionModule,MatButtonModule,MatFormFieldModule,MatInputModule, } from '@angular/material';
...
@NgModule({
    imports     : [
        ...
        MatIconModule,
        MatRippleModule,
        MatExpansionModule,MatButtonModule,MatFormFieldModule,MatInputModule,MatIconModule,
